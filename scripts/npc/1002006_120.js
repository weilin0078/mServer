   ...
   status--;
	...
	text += "     \r\n"
        cm.sendSimple(text);
            ...
            cm.dispose();
        } else if(cm.haveItem(4001083,1) && cm.haveItem(4000152,50) && cm.haveItem(4000151,50) && cm.haveItem(4000407,50) && cm.haveItem(4000402,30) && cm.haveItem(4000406,30) && cm.haveItem(1012176,1) && cm.getMeso() > 10000000){
...
cm.gainItem(1012083,15,15,15,15,3000,3000,0,0,0,0,0,0,0,0);
            cm.sendOk("换购成功！");
            cm.dispose();
//cm.喇叭(3, "玩家：[" + cm.getPlayer().getName() + "]成功制作3000HP血衣，恭喜！！");
			}else{
            cm.sendOk("无法制作，或许你\r\n#v4001083#不足1个-----通过天鹰获得\r\n#v4000152#不足50个\r\n#v4000151#不足50个\r\n#v4000407#不足50个\r\n#v4000402#不足30个\r\n#v4000406#不足30个\r\n#v1012176#不足1个\r\n");
            cm.dispose();
			}
		}
    }
