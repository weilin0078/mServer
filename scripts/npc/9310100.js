...
var status = 0;
  ...
  var textz = "   #e#d" + 蓝蜗牛 + "欢迎来到天天冒险岛，这里是中介系统#k\r\n#r\r\n";
 textz += "#L5#1.#v4030008##z4030008# 需要:2000点券 \r\n";
  //textz += "#L1#4.#v5570000##z5570000# 需要:#v4000235#30个 \r\n";
   textz += "#L2#2.兑换1600点券  需要:#v4030008#1个 \r\n";
   textz += "#L3#3.#v1032035##z1032035 # 需要:#v4000016#200个\r\n";
  //textz += "#L4#4.#v1122134##z1122134# 需要:#v4005001#25个 \r\n";
   //textz += "#L1#5.#v1122135##z1122135# 需要:#v4005002#25个 \r\n";
  ...
  //textz += "#L17#8.#v1072853##z1072853# 需要:#v4251202#7个#v4001129#1个 \r\n";
		...
		cm.sendSimple (textz);  
          ...
          cm.openNpc(9310100, 2);
               ...
               cm.sendOk("请带来#v4000016##z4000016#*200");
         cm.dispose();
} else  if (cm.getMeso() < 20000) {
 			cm.sendOk("请带来#r2W#k金币#k");
      			cm.dispose();
  } else{
