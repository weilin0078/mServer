...
var status = 0;
	...
	if (status == 0) {
	    ...
	    var textz = "#d欢迎来到我爱冒险岛，我是本服副本兑换系统。#k\r\n#r#v4251200#所有常规副本都出1个。#k\r\n";

  textz += "#L1#1.#v4031227##z4031227# 需要:#v4251200#1个 \r\n";
  // textz += "#L2#2.#v4001226##z4001226# 需要:#v4251202#2个 \r\n";
  ...
  textz += "#L13#5.#v1052647##z1052647# 需要:#v4251202#5个#v4001129#3个#v4310143#8个 \r\n";
  textz += "#L14#6.#v1082540##z1082540# 需要:#v4251202#5个#v4001129#3个#v4310143#8个  \r\n";
  textz += "#L15#7.#v1102612##z1102612# 需要:#v4251202#5个#v4001129#3个#v4310143#8个  \r\n";
  textz += "#L16#8.#v1003946##z1003946# 需要:#v4251202#5个#v4001129#3个#v4310143#8个  \r\n";
  textz += "#L17#9.#v1072853##z1072853# 需要:#v4251202#5个#v4001129#3个#v4310143#8个 \r\n";
    ...
    cm.sendOk("请带来#v425102##z4251202#*2");
         cm.dispose();
...
(net.sf.cherry.client.MapleInventoryType.getByType(1)).isFull(3)){
   ...
   cm.dispose();
    ...
    cm.sendOk("请带来#v4251202##z4251202#*5");
         cm.dispose();
                  } else if (!cm.haveItem(4001129,3)) {
    cm.sendOk("请带来#v4001129##z4001129#*3");
         cm.dispose();
        } else if (!cm.haveItem(4310143,8)) {
    cm.sendOk("请带来#v4310143##z4310143#*8");
         cm.dispose();
  } else{
  ...
  cm.gainItem(4310143,-8);
   ...
   cm.sendOk("#b兑换成功")
   cm.dispose();
cm.喇叭(3,"["+cm.getName()+"]兑换了[革命装备]，多多参加活动，兑换丰厚奖励~！");
            cm.dispose();
}
