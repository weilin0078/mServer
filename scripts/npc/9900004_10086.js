	...
	if (mode == -1) {
		...
		if (status == 0) {
			...
			if (selection == 1) {
				...
				cm.sendOk("#b亲爱的#r#h ##b你好，欢迎你的到来！！我为你准备了丰富的新手礼包！！\r\n\r\n#r点卷=3000点、新手勋章一枚、特殊药水=50个、沙拉=50个、白色药水=50个、喇叭=5个");
		...
		cm.gainItem(2000002,+50);
                cm.gainNX(+300);
                                cm.喇叭(3,"欢迎新人！！大家祝贺吧！！！~又是一名新人加入了回归冒险岛~！");
                                cm.dispose();
			} 
		}
	}
