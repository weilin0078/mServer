...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            var text = "";
            for (i = 0; i < 10; i++) {
                text += "#k欢迎来到#r天天冒险岛#k，这里能领取充值物品哦!瞬间成为土豪\r\n\r\n";
            text += "#L1##d#v4310014##z4310014#\t领取累计充值100礼包#l\r\n\r\n"//
            //text += "#L2##d#v4310016##z4310016#\t领取累计充值200礼包#l\r\n\r\n"//
            text += "#L3##d#v4310049##z4310049#\t领取累计充值300礼包#l\r\n\r\n"
            text += "#L4##d#v4310011##z4310011#\t领取累计充值500礼包#l\r\n\r\n"
            //text += "#L5##d#v4310018##z4310018#\t领取累计充值800礼包#l\r\n\r\n"
            text += "#L6##d#v4310028##z4310028#\t领取累计充值1000礼包#l\r\n\r\n"
            text += "#L7##d#v4310025##z4310025#\t领取累计充值2000礼包#l\r\n\r\n"
            text += "#L8##d#v4310010##z4310010#\t领取累计充值3000礼包#l\r\n\r\n"
            cm.sendSimple(text);
            }
        } else if (selection == 1) {
