...
if((cm.getBossLog('xslb') < 1) && cm.getLevel() > 9) {
					...
					cm.gainNX(+50);
                                        ...
                                        //cm.gainMeso(99999);
					cm.serverNotice("欢迎新人！！大家祝贺吧！！！~又是一名新人加入了独家冒险岛~！");
					cm.setBossLog('xslb');
					}else{
