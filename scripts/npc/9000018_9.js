...
function action(mode, type, selection) {
    if (mode == -1) {
		...
		cm.openNpc(9000018, 91);
        } else if (selection == 2) {
		cm.openNpc(9000018, 92);
        } else if (selection == 3) {
		cm.openNpc(9000018, 93);
        } else if (selection == 4) {
		cm.openNpc(9000018, 94);
        } else if (selection == 5) {
		cm.openNpc(9000018, 95);
        } else if (selection == 6) {
		cm.openNpc(9000018, 96);
        } else if (selection == 7) {
		cm.openNpc(9000018, 97);
        } else if (selection == 8) {
		cm.openNpc(9000018, 98);
        } else if (selection == 9) {
		cm.openNpc(9000018, 99);
        } else if (selection == 10) {
		cm.openNpc(9000018, 910);
        } else if (selection == 11) {
		cm.openNpc(9000018, 911);
        } else if (selection == 12) {
		cm.openNpc(9000018, 912);
        } else if (selection == 13) {
		cm.openNpc(9000018, 913);
        } else if (selection == 14) {
		cm.openNpc(9000018, 914);
        } else if (selection == 15) {
		cm.openNpc(9000018, 915);
        } else if (selection == 16) {
		cm.openNpc(9000018, 916);
	}
    }
}
