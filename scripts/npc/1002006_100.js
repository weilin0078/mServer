   ...
   status--;
	...
	text += "     \r\n"
        cm.sendSimple(text);
            ...
            cm.dispose();
        } else if(cm.haveItem(4000017,2) && cm.haveItem(4021000,5) && cm.haveItem(4021006,5) && cm.haveItem(4021002,5) && cm.getMeso() > 10000000){
				cm.gainItem(4000017, -2);
				cm.gainItem(4021000, -5);
				cm.gainItem(4021006, -5);
				cm.gainItem(4021002, -5);
                                cm.gainMeso(-10000000);
cm.gainItem(1012412,5,5,5,5,1000,1000,0,0,0,0,0,0,0,0);
            cm.sendOk("换购成功！");
            cm.dispose();
