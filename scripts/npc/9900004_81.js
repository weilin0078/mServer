...
var status = 0;
	...
	if (status == 0) {
	    ...
	    var textz = "#d欢迎来到天天冒险岛，这里是冒险之心升级处#k\r\n";
 textz += "#L1#1.#v4001226##z4001226# 需要:#v4251202#2个 \r\n";
  //textz += "#L1#1.#v5570000##z5570000# 需要:#v4000235#30个 \r\n";
   ...
   textz += "#L3#3.#v1122133##z1122133 # 需要:#v4005000#25个#v1122132#\r\n";
  textz += "#L4#4.#v1122134##z1122134# 需要:#v4005001#25个 #v1122132#\r\n";
   textz += "#L5#5.#v1122135##z1122135# 需要:#v4005002#25个#v1122132# \r\n";
   textz += "#L6#6.#v1122136##z1122136# 需要:#v4005003#25个#v1122132# \r\n";
   textz += "#L7#7.#v1122137##z1122137# 需要:#v4021004#25个#v1122132# \r\n";
   textz += "#L8#8.#v1122029##z1122029# 需要:#v1122133#1个#v4011001#100个  \r\n";
   textz += "#L11#9.#v1122030##z1122030# 需要:#v1122134#1个#v4011002#100个  \r\n";
  textz += "#L10#10.#v1122031##z1122031# 需要:#v1122135#1个#v4011003#100个  \r\n";
  textz += "#L9#11.#v1122032##z1122032# 需要:#v1122136#1个#v4011004#100个  \r\n";
  textz += "#L12#12.#v1122033##z1122033# 需要:#v1122137#1个#v4011005#100个  \r\n";
 ...
 // textz += "#L14#10.#v2041139##z2041139# 需要:#v4005002#100个#v4001129#7个  \r\n";
  ...
  //textz += "#L17#8.#v1072853##z1072853# 需要:#v4251202#7个#v4001129#1个 \r\n";
   ...
   cm.dispose();
                  ...
                  if (!cm.haveItem(4005000,25)) {
               cm.sendOk("请带来#v4005000##z4005000#*25");
         cm.dispose();
 } else  if (!cm.haveItem(1122132,1)) {
               cm.sendOk("请带来#v1122132##z1122132#*1");
         cm.dispose();
 ...
 cm.gainMeso(-20000000);
   ...
   cm.dispose();
    ...
    cm.sendOk("请带来#v1122133##z1122133#*1");
         cm.dispose();
 } else  if (!cm.haveItem(4011001,100)) {
               cm.sendOk("请带来#v4011001##z4011001#*100");
         cm.dispose();
} else  if (cm.getMeso() < 20000000) {
 			cm.sendOk("请带来#r20000000W#k金币#k");
      			cm.dispose();
...
cm.gainItem(4011001,-100);
   ...
   cm.dispose();
                  ...
                  if (!cm.haveItem(4011004,100)) {
    cm.sendOk("请带来#v4011004##z4011004#*100");
         cm.dispose();
 } else  if (!cm.haveItem(1122136,1)) {
  ...
  cm.gainItem(4011002,-100);
   ...
   cm.dispose();
    ...
    cm.sendOk("请带来#v1122135##z1122135#*1");
         cm.dispose();
 } else  if (!cm.haveItem(4011003,100)) {
               cm.sendOk("请带来#v4011003##z4011003#*100");
         cm.dispose();
} else  if (cm.getMeso() < 20000000) {
 			cm.sendOk("请带来#r20000000W#k金币#k");
      			cm.dispose();
  ...
  cm.gainItem(4011003,-100);
   ...
   cm.dispose();
    ...
    cm.sendOk("请带来#v1122137##z1122137#*1");
         cm.dispose();
 } else  if (!cm.haveItem(4011005,100)) {
               cm.sendOk("请带来#v4011005##z4011005#*100");
         cm.dispose();
} else  if (cm.getMeso() < 20000000) {
 			cm.sendOk("请带来#r20000000#k金币#k");
      			cm.dispose();
  ...
  cm.gainItem(4011005,-100);
   ...
   cm.dispose();
    ...
    cm.sendOk("请带来#v1122134##z1122134#*1");
         cm.dispose();
 } else  if (!cm.haveItem(4011004,100)) {
               cm.sendOk("请带来#v4011004##z4011004#*100");
         cm.dispose();
} else  if (cm.getMeso() < 20000000) {
 			cm.sendOk("请带来#r20000000W#k金币#k");
