...
public class MapleQuest implements Serializable
{
    ...
    private static Map<Integer, MapleQuest> quests;
    protected int id;
    ...
    public static void initQuests() {
        MapleQuest.questData = MapleDataProviderFactory.getDataProvider(new File(System.getProperty("net.sf.odinms.wzpath") + "/Quest.wz"));
    ...
    static {
        MapleQuest.quests = new LinkedHashMap<Integer, MapleQuest>();
    }
