...
public class MapleReactorFactory
{
    ...
    private static Map<Integer, MapleReactorStats> reactorStats;
    ...
    static {
        data = MapleDataProviderFactory.getDataProvider(new File(System.getProperty("net.sf.odinms.wzpath") + "/Reactor.wz"));
        MapleReactorFactory.reactorStats = new HashMap<Integer, MapleReactorStats>();
    }
}
