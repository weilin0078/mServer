...
public class MobAttackInfoFactory
{
    ...
    private static Map<Pair<Integer, Integer>, MobAttackInfo> mobAttacks;
    ...
    static {
        ...
        dataSource = MapleDataProviderFactory.getDataProvider(new File(System.getProperty("net.sf.odinms.wzpath") + "/Mob.wz"));
        MobAttackInfoFactory.mobAttacks = new HashMap<Pair<Integer, Integer>, MobAttackInfo>();
    }
}
