...
{
    private static Map<Pair<Integer, Integer>, MobSkill> mobSkills;
    ...
    static {
        MobSkillFactory.mobSkills = new HashMap<Pair<Integer, Integer>, MobSkill>();
        MobSkillFactory.dataSource = MapleDataProviderFactory.getDataProvider(new File(System.getProperty("net.sf.odinms.wzpath") + "/Skill.wz"));
