...
public class MapleLifeFactory
{
    ...
    static {
        data = MapleDataProviderFactory.getDataProvider(new File(System.getProperty("net.sf.odinms.wzpath") + "/Mob.wz"));
        ...
        MapleLifeFactory.npcNames = new HashMap<Integer, String>();
        MapleLifeFactory.monsterStats = new HashMap<Integer, MapleMonsterStats>();
        MapleLifeFactory.NPCLoc = new HashMap<Integer, Integer>();
        MapleLifeFactory.questCount = new HashMap<Integer, List<Integer>>();
    }
}
