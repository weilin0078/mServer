...
public class MapleFamily implements Serializable
{
    ...
    public final void broadcast(final MaplePacket packet, final List<Integer> cids) {
        this.broadcast(packet, -1, FCOp.NONE, cids);
    }
    
    public final void broadcast(final MaplePacket packet, final int exception, final List<Integer> cids) {
        this.broadcast(packet, exception, FCOp.NONE, cids);
    }
    
    public final void broadcast(final MaplePacket packet, final int exceptionId, final FCOp bcop, final List<Integer> cids) {
