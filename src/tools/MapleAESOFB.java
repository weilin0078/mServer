...
public class MapleAESOFB
{
    ...
    public MapleAESOFB(final byte[] iv, final short mapleVersion) {
        try {
            (this.cipher = Cipher.getInstance("AES")).init(1, MapleAESOFB.skey);
        }
    ...
    static {
        ...
        MAPLE_AES_KEY = new byte[] { 19, 0, 0, 0, 8, 0, 0, 0, 6, 0, 0, 0, -76, 0, 0, 0, 27, 0, 0, 0, 15, 0, 0, 0, 51, 0, 0, 0, 82, 0, 0, 0 };
